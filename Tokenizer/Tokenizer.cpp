...
int ConsumeState::currentLineCount() { return _pContext->_lineCount; }
...
{
  for (int i = 0; i < (int)_pContext->_oneCharTokens.size(); ++i)
...
{
  for (int i = 0; i < (int)_pContext->_twoCharTokens.size(); ++i)
