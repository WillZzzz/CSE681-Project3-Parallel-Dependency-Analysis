...
{
  int openParenPosition = find("(");
  int semiColonPosition = find(";");
  int closedParenPosition = find(")");
...
Token SemiExp::operator[](int n) const
{
